## <td class="topic starter"><a href="http://moodle.dhbw-mannheim.de/mod/forum/discuss.php?d=14033">"Middleware" in relation to mobile operating systems</a></td><div class="posting fullpost">
...
<div class="posting fullpost">
 ...
 <p><span lang="en-us" xml:lang="en-us">Time shared system further provide means for protecting its resources from inappropriate use. </span></p>
 <br>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 ...
 <p>Furthermore it can stop programs that would otherwise run endlessly</p>
 <p><br></p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 ...
 <p><br></p>
 <p>New: Creation of a new process</p>
 <p>Running: Instructions are being executed</p>
 <p>Waiting: The process is waiting for some event to occur (such as an I/O completion or reception of a signal)</p>
 <p>Ready: The process is waiting to be assigned to a processor.</p>
 <p>Terminated: Execution of the process has finished.<br></p>
 <div class="attachedimages"></div>
</div>
---

<div class="posting fullpost">
 I completely agree with Jins answer and I would just add the Page where you can find it. &nbsp;(page 166; Chapter 3.1.2)
 <div class="attachedimages"></div>
</div>
---
...
###  Explain briefly the stack and heap. Also name a well known exception which might be raise in this context and why.
 <br>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <span class="b4">Everything h</span>
 <span class="b3">as be</span>
 <span class="b4">en</span>
 <span class="b5"> said</span> and I do not w
 <span class="b1">an</span>
 <span class="b2">t to r</span>
 <span class="b1">ep</span>eat 
 <span class="b1">wh</span>
 <span class="b2">at ha</span>
 <span class="b3">s already been </span>
 <span class="b4">said.<br><br></span>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 ...
 <br>
 <br>The Answer(s) were not only briefly but are fare more detailed as needed!
 <br>
 <br>The most important points your should focus on are the following:
 <br>
 <br>Stack
 <br>
 <ul>
  <li>LiFo principe</li>
  <li>stores information/data for threads</li>
 </ul>
 <p>Heap</p>
 <ul>
  <li>Stores data and allows memory allocation for threads</li>
 </ul>
 <p>both work from different directions: If Stack reaches the edge of Heap an Exception occures! The Stackoverflow exception. Think about infinite Loops in this case.</p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <p>The different thread issues are:</p>
 <p>1. The fork() and exec() System Calls</p>
 <p>2. Signal Handling</p>
 <p>3. Thread Pools</p>
 <p>4. Thread-Specific Data</p>
 <p>5. Scheduler Activations</p>
 <p><b>6. Cancellation:</b></p>
 <p>Thread cancellation is when one thread is allowed to terminate the execution of any other thread (target thread) in the process.&nbsp;</p>
 <p>For example, if multiple threads are searching through a database and one find the result, it will then terminate all other threads also searching in the database.&nbsp;</p>
 <p>There are two different types of thread cancellation: Asynchronous and Deferred.</p>
 <p>Asynchronous cancellation means that one thread immediately terminates the target thread.</p>
 <p>Deferred cancellation means that the target threads frequently checks if it should be terminated, allowing it an opportunity to terminate itself in an orderly fashion. The cancellation point is the safety point where a thread can be terminated after being checked to ensure no data will be lost.</p>
 <p><br></p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <p><span style="line-height:1.5em;">Different kind of threading issues:</span><br></p>
 <p style="margin:5px 0px;padding:0px 0px 5px;font-family:Helvetica, Arial, sans-serif;line-height:1.5em;color:rgb(102,102,102);font-size:15px;font-style:normal;font-variant:normal;letter-spacing:normal;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;background-color:rgb(255,255,255);">1. The fork() and exec() System Calls</p>
 <p style="margin:5px 0px;padding:0px 0px 5px;font-family:Helvetica, Arial, sans-serif;line-height:1.5em;color:rgb(102,102,102);font-size:15px;font-style:normal;font-variant:normal;letter-spacing:normal;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;background-color:rgb(255,255,255);">2. Cancellation</p>
 <p style="margin:5px 0px;padding:0px 0px 5px;font-family:Helvetica, Arial, sans-serif;line-height:1.5em;color:rgb(102,102,102);font-size:15px;font-style:normal;font-variant:normal;letter-spacing:normal;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;background-color:rgb(255,255,255);">3. Signal handling</p>
 <p style="margin:5px 0px;padding:0px 0px 5px;font-family:Helvetica, Arial, sans-serif;line-height:1.5em;color:rgb(102,102,102);font-size:15px;font-style:normal;font-variant:normal;letter-spacing:normal;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;background-color:rgb(255,255,255);">4. Thread pools</p>
 <p style="margin:5px 0px;padding:0px 0px 5px;font-family:Helvetica, Arial, sans-serif;line-height:1.5em;color:rgb(102,102,102);font-size:15px;font-style:normal;font-variant:normal;letter-spacing:normal;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;background-color:rgb(255,255,255);"><span style="line-height:1.5em;">5. Scheduler activators</span></p>
 <p style="margin:5px 0px;padding:0px 0px 5px;font-family:Helvetica, Arial, sans-serif;line-height:1.5em;color:rgb(102,102,102);font-size:15px;font-style:normal;font-variant:normal;letter-spacing:normal;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;background-color:rgb(255,255,255);"><span style="line-height:1.5em;"><span style="color:rgb(102,102,102);font-family:Helvetica, Arial, sans-serif;font-size:15px;font-style:normal;font-variant:normal;font-weight:normal;letter-spacing:normal;line-height:22.5px;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;float:none;background-color:rgb(255,255,255);">6. Thread-specific data:</span><br></span></p>
 <p style="margin:5px 0px;padding:0px 0px 5px;font-family:Helvetica, Arial, sans-serif;line-height:1.5em;color:rgb(102,102,102);font-size:15px;font-variant:normal;letter-spacing:normal;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;background-color:rgb(255,255,255);"><span style="line-height:1.5em;"><span style="font-style:normal;color:rgb(102,102,102);font-family:Helvetica, Arial, sans-serif;font-size:15px;font-variant:normal;font-weight:normal;letter-spacing:normal;line-height:22.5px;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;float:none;background-color:rgb(255,255,255);">Threads belonging to a process share the data of the process. Indeed, this sharing of data provides one of the benefits of multithreaded programming. However, in some circumstances, each thread might need its own copy of certain data. We will call such data </span><span style="color:rgb(102,102,102);font-family:Helvetica, Arial, sans-serif;font-size:15px;font-variant:normal;font-weight:normal;letter-spacing:normal;line-height:22.5px;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;float:none;background-color:rgb(255,255,255);"><i>thread-specific data</i></span><span style="font-style:normal;color:rgb(102,102,102);font-family:Helvetica, Arial, sans-serif;font-size:15px;font-variant:normal;font-weight:normal;letter-spacing:normal;line-height:22.5px;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;float:none;background-color:rgb(255,255,255);">. For example, in a transaction-processing system, we might service each transaction in a separate thread, and each transaction might be assigned a unique identifier. To associate each thread with its unique identifier, we could use thread-specific data. Most thread libraries provide form of support for thread-specific data (Java provides support as well).</span></span></p>
 <p style="margin:5px 0px;padding:0px 0px 5px;font-family:Helvetica, Arial, sans-serif;line-height:1.5em;color:rgb(102,102,102);font-size:15px;font-style:normal;font-variant:normal;letter-spacing:normal;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;background-color:rgb(255,255,255);"><br></p>
 <p style="margin:5px 0px;padding:0px 0px 5px;text-align:left;text-indent:0px;background-color:rgb(255,255,255);">(Sorry for the late answer, I had problems with my Moodle..)<br></p>
 <br>
 <p></p>
 <div class="attachedimages"></div>
</div>
...
<div class="posting fullpost">
 <p></p>
 <p></p>
 <p>A zombie process is a process in Unix OS that has completed execution, but still has an entry in the process table. This process is an old child process that is executed, but it waits for the parent process to send a status, when the parent process get the status, the zombie process are killed. A zombie process directed himself no damage.</p>
 <span class="shorttext"><span style="font-size:11pt;line-height:115%;font-family:Calibri, 'sans-serif';" lang="en" xml:lang="en"></span></span>
 <br>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <p>A zombie process is a process in the state after termination, but before it's process identifier and entry in the process table are released. This is the case if the process is terminated, but the parent did not yet call wait(). Processes usually exist only briefly as zombie processes.</p>
 <div class="attachedimages"></div>
</div>
---

<div class="posting fullpost">
 <p>Both are correct, thank you.</p>
 <div class="attachedimages"></div>
</div>
---

<div class="posting fullpost">
 <p>On Unix and Unix-like computer operating systems, a zombie process or defunct process is a process that has completed execution (via the exit system call) but still has an entry in the process table: it is a process in the "Terminated state". This occurs for child processes, where the entry is still needed to allow the parent process to read its child's exit status: once the exit status is read via the wait system call, the zombie's entry is removed from the process table and it is said to be "reaped". A child process always first becomes a zombie before being removed from the resource table. In most cases, under normal system operation zombies are immediately waited on by their parent and then reaped by the system – processes that stay zombies for a long time are generally an error and cause a resource leak.<br></p>
 <p>(Sorry for the late answer, I had problems with my Moodle..)</p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <p>Multiprocessor systems contains multiple CPUs and can therefore work in parallel. This is called "SMP" (Simultaneous Multiprocessing)<br><br>Multicore systems contain only one CPU which has duplicated components which enables it to work in parallel on seperate operatons. This is called CMP (Chip-level Multiprocessing)</p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 ...
 <p></p>
 <p></p>
 <p>A multicore System has a single processor with multiple Independent cores. These cores are responsible for reading and executing the instructions of a program on the CPU. In contrast, a multiprocessor System has multiple CPU-s which form an integrated computer System.</p>
 <p><br></p>
 <p><br></p>
 <p><br></p>
 <p><br></p>
...
<div class="posting fullpost">
 <p>Thank you for your answers, both were correct.</p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <p>The long-term scheduler selects processes from a pool of processes on a mass storage device waiting for later execution and loads them into main memory for execution.</p>
 <p>The short-term scheduler selects from the processes that are ready to execute and allocates the CPU to one of them.</p>
 <div class="attachedimages"></div>
</div>
---

<div class="posting fullpost">
 <p>Short term scheduling is when we select exactly one process from the ready queue.</p>
 <p>Long term scheduling describes the assortment of a cluster of processes that can skirmish for the CPU. <br>It is usually influenced by resource-allocation considerations.<br></p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 ...
 <p><br></p>
 <p>I'll stick with a mix out of both answers! :)</p>
 <p><br></p>
 <p><span style="color:rgb(102,102,102);font-family:Helvetica, Arial, sans-serif;font-size:12px;font-style:normal;font-variant:normal;font-weight:normal;letter-spacing:normal;line-height:18px;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;float:none;background-color:rgb(255,255,255);"><span style="color:rgb(102,102,102);font-family:Helvetica, Arial, sans-serif;font-size:12px;font-style:normal;font-variant:normal;font-weight:normal;letter-spacing:normal;line-height:18px;text-align:left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;float:none;background-color:rgb(255,255,255);">The short-term scheduler selects from the processes that are ready to execute and allocates the CPU to one of them.</span><br></span></p>
...
###  <p>Explain the difference between independent and cooperating processes when executed concurrently in the OS and give reasons for providing and environment that allows process cooperation.</p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 ...
 <br>An cooperating process can affect or be affected by the execution of another process.
 <br>
 <br>Positive aspects:
 <br>- more efficient/ faster computing
 <br>- modularity
 <br>- data sharing
 <br>- convenience
 <br>
 <br>There are two environments of IPC:
 <br>- shared memory
 <br>- message passing
 <br>
 <div class="attachedimages"></div>
...
<div class="posting fullpost">
 <p><span style="font-size:12pt;line-height:107%;font-family:'Times New Roman', serif;color:#231F20;" xml:lang="en-us" lang="en-us">The <b>difference</b> between independent and cooperating processes can basically described whether processes share data or not.</span></p> 
 <p><span style="font-size:12pt;line-height:107%;font-family:'Times New Roman', serif;color:#231F20;" xml:lang="en-us" lang="en-us">An <u>independent process</u> cannot affect or is not affected by other processes that are executed in the system. That’s why an independent process does not share any data with another process executed in the system. </span></p> 
 <p><span style="font-size:12pt;line-height:107%;font-family:'Times New Roman', serif;" xml:lang="en-us" lang="en-us">In contrast, <u>cooperating processes</u> can affect or are affected by other processes executing in the system. Therefore, a cooperating process is one that shares data with other processes.</span></p> 
 <p><span style="font-size:12pt;line-height:107%;font-family:'Times New Roman', serif;" xml:lang="en-us" lang="en-us">Process cooperation is an important principle modern operating systems are endowed with. Of course, there are <b>reasons</b> for providing an environment that allows such a process cooperation.</span></p> 
 <p><span style="font-size:12pt;line-height:107%;font-family:'Times New Roman', serif;" xml:lang="en-us" lang="en-us">First of all, a main point is <i>share of information</i>. Several users could be interested in the same piece of information, so we have to provide an environment that allows us to access such information concurrently.</span></p> 
 <p><span style="font-size:12pt;line-height:107%;font-family:'Times New Roman', serif;" xml:lang="en-us" lang="en-us">Secondly, <i>computation speedup</i> is a benefit of cooperating processes as well. In order to make a computer run faster, we have to separate one task into several subtasks. To achieve this, the subtasks must be executed in parallel. </span></p> 
 <p><span style="font-size:12pt;line-height:107%;font-family:'Times New Roman', serif;" xml:lang="en-us" lang="en-us">Thirdly, the <i>modularity</i> aspect. We may want to divide the system functions into separate processes or threads so that the system is constructed in a modular fashion.</span></p> 
 <p><span style="font-size:12pt;line-height:107%;font-family:'Times New Roman', serif;" xml:lang="en-us" lang="en-us">Finally, more than one user might work on different tasks at the same time. So the <i>convenience</i> represents a reason as well. &nbsp;</span></p>
 <div class="attachedimages"></div>
</div>
---

<div class="posting fullpost">
 <p>That you for your answers, that is what I was looking for!</p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <p>A socket is defined as an endpoint for communication. A pair of processes that wish to communicate over a network employ a pair of sockets; one for each of the processes. A socket is identified by an IP address merged with a port number ie (127.0.0.1:21). In a client-server architecture, the server accepts a connection from the client socket ot complete a connection.&nbsp;</p>
 <p><br></p>
 <p>In Java, sockets can be set up in three different ways; Connection-orientated (TCP) sockets which utilizes the Socket class, Connectionless (UDP) sockets use the datagramSocket class, and MulticastSocket class is a subclass of the DatagramSocket class which allows data to be sent to multiple recipients.</p>
 <div class="attachedimages"></div>
</div>
---

<div class="posting fullpost">
 <p>A socket is provided by the OS and is defined as an endpoint of communication. A socket is identified through a IP address and a port number.<br>Usually they use a client-server architecture. <br>In Java you can set up a connection in different ways:</p>
 <p>1. Connection-oriented (TCP) (with the Socket class)<br>2.Communication less (UDP) sockets</p>
 <p><br></p>
 <div class="attachedimages"></div>
</div>
---
...
###  <p>Explain briefly&nbsp; what is meant with the term multiprocess architecture! Explain if the google chrome browser is multiprocess using the technical terms leaned in the sessions. <br></p>
 <p><br></p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <p>The Google Chrome browser uses employs a multiprocess architecture by splitting different functional areas, such as the renderer, the core browser process and several plug-ins into different proccesses.<br><br>This way every website runs isolated from the other open websites and if one crashes, only its renderer process is effected.<br>Furthermore, this renderer process runs in a sandbox and only has restricted access to disk/network I/O, which minimises the harmful effects of exploits. &nbsp;</p>
 <div class="attachedimages"></div>
</div>
---

<div class="posting fullpost">
 <p>Well and short explained, very good! Your answer is right.<br></p>
 <div class="attachedimages"></div>
</div>
---

<div class="posting fullpost">
 <p>Like Tobias already said, a multiprocess architecture splits up different logical tasks into different processes.</p>
 <p>The Chrome web browser is multiprocessing, because it splits its tasks into three categories of processes: the browser, the renderer and the plug-ins.</p>
 <div class="attachedimages"></div>
</div>
---

<div class="posting fullpost">
 <p>Right answer too!<br></p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 Lukas is completely right, nothing to add to his answer.
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <p>Hello guys,</p>
 <p>I am sorry for that late response but i had some connection issues at my parents house. Since our class isn´t till tmrw i hope it is still alright for you.</p>
 <p>As Michael mentioned above Quynhs answers is correct. <br></p>
 <p>Sorry again for that late response but you guys already did fine.<br></p>
 <p><br></p>
 <p><br></p>
 <div class="attachedimages"></div>
</div>
...
<div class="posting fullpost">
 <p>Thank you for your correct answer.</p>
 <p>Nonpreemptive decisions are taken by the process itself, because it knows when its finished (terminating) or when its waiting for I/O (running to waiting).<br></p>
 <p><br></p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <p>Both answers are correct, thank you very much.</p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <p>Thanks a lot for your correct answers!<br></p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 Tobi's answer is correct and can be found on page 203.
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <p></p>
 <p><i><span style="font-size:10pt;" lang="en-us" xml:lang="en-us">Exactly, that is the answer I was looking for.</span></i></p> 
 <p style="line-height:normal;"><span style="font-size:12pt;font-family:'Times New Roman', serif;" lang="en-us" xml:lang="en-us">You can find the <u>final answer</u> below.</span><span style="font-size:10.5pt;font-family:'Palatino-Roman';color:#231F20;" lang="en-us" xml:lang="en-us"></span></p> 
 <p><span style="font-size:10pt;" lang="en-us" xml:lang="en-us">1. <u>Mutual exclusion</u>. If a process is executing in its critical section, then no other processes can be executing in their critical sections.</span></p> 
 <p><span style="font-size:10pt;" lang="en-us" xml:lang="en-us">2. <u>Progress</u>. If no process is executing in its critical section and some processes wish to enter their critical sections, then only those processes that are not executing in their remainder sections can participate in deciding which will enter its critical section next. This selection cannot be postponed indefinitely.</span></p> 
 <p><span style="font-size:10pt;" lang="en-us" xml:lang="en-us">3. <u>Bounded waiting</u>. There exists a bound, or limit, on the number of times that other processes are allowed to enter their critical sections after a process has made a request to enter its critical section and before that request is granted.</span><span lang="en-us" xml:lang="en-us"></span></p>
 <p><br></p>
 <p><br></p>
 <br>
 <span style="font-size:10.5pt;line-height:107%;font-family:'Palatino-Roman';color:#231F20;" lang="en-us" xml:lang="en-us"></span>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 Thank you for your answers! Both are very accurate and correct.
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <p>The answers are&nbsp;correct!<br></p>
 <div class="attachedimages"></div>
</div>
---
...
<div class="posting fullpost">
 <p>Thank you for your answers, they are perfect!</p>
 <div class="attachedimages"></div>
</div>
---
